...
public final class Names {
    public static final class Config {
        ...
        public static final String PRIORITY_DESC = "How block placement should be prioritized. 1=layers, 2=pillars, 3=pillars (below only), 4=closes first, 5=furthest first.";
